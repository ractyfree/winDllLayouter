...
#define RandomNumber(Min, Max) (Min + (Random() % (Max - Min + 1)))
	...
	private:
		...
		static const Char XORKEY = static_cast<Char>(123456);
...
#define XorString( String ) ( utils::XorStringT<char, utils::ConstructIndexList<sizeof( String ) - 1>::Result>( String ).decrypt() )
#define XorStringW( String ) ( utils::XorStringT<wchar_t, utils::ConstructIndexList<(sizeof( String ) - 1) / 2>::Result>( String ).decrypt() )
